...
public class AccountsObjectDev {
	...
	public By Account_ContactTab(String L) {
		if (L.equals("E")) {
			return By.xpath("/html/body/div[4]/div[1]/section/div/div/div[1]/div[4]//li[@title = 'Contacts']/a");
	...
	public By NewAccountName = By.xpath("//label/span[.='Account Name']/../../input");
	...
	public By HLPanel_Button_NeuerKontakt = By.xpath("//a[contains(@title, 'New Contact')]");
