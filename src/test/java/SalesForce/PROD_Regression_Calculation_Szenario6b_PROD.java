...
public class PROD_Regression_Calculation_Szenario6b_PROD extends base{
...
public void initialize() throws IOException, InterruptedException {
	...
	public void PROD_Regression_Calculation_Szenario5() throws InterruptedException, IOException, ParseException, java.text.ParseException {
		...
		Log.info("PROD_Regression_Calculation_Szenario6b");
		...
		pass = test.createStockTruck(driver, wait, "DI83S1LW");
		if (!pass) {
			testpass = false;
		}
		...
		pass = test.checkCalculationNew(driver, wait, randomValue, logText_1, "1", false, "", "Vorfuhrfahrzeug", "Demo", "0.00", "0.00", false, "0.00", "0.00", false);
		if (!pass) {
			testpass = false;
		}
		...
		Log.info("Check calculations");
		pass = test.checkCalculationNew(driver, wait, randomValue, logText_2, "1", false, "", "Vorfuhrfahrzeug", "Demo", "0.00", "0.00", false, "0.00", "0.00", false);
		if (!pass) {
			testpass = false;
		}
		/*
